...
{
global $config;
global $script_js,$modul,$action,$id;
...
function info_prospek($prospek_list_id) {
    ...
    SELECT 
    p.id,pr.kode produk_kode,pr.nama produk_nama,l.lembaga_nama,l.lembaga_alamat,l.lembaga_telp,l.lembaga_email,l.pic_nama_lengkap,l.pic_nama_panggilan,l.pic_agama,l.pic_jabatan,l.pic_whatsapp,l.pic_email,p.next_fu,p.last_fu,p.status,p.catatan 
    FROM 
    lembaga l 
