...
function btn_done($url,$params=array()) {
	return btn_generic($url,"fa-check","btn-info",$params);
}
function btn_delete_swal($url) {
	return 	'<a style="margin-right:5px;color:white;" class="btn btn-xs btn-danger"><i class="fa fa-trash" onclick="action_hapus(\''.$url.'\')"></i></a>';
}
