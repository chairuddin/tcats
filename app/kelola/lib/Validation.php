<?php
    ...
    class Validation {
        ...
        public function pattern($name){
            ...
            if($name == 'array'){
                ...
                if(!is_array($this->value)){
                    $this->errors[] = 'Format salah '.$this->name.' tidak valid.';
                }
        ...
        public function customPattern($pattern){
            ...
            $regex = '/^('.$pattern.')$/u';
            if($this->value != '' && !preg_match($regex, $this->value)){
                $this->errors[] = 'Isian '.$this->name.' tidak valid.';
            }
            return $this;
        ...
        public function required(){
            ...
            if((isset($this->file) && $this->file['error'] == 4) || ($this->value == '' || $this->value == null)){
                $this->errors[] = ucfirst($this->name).' Harus diisi.';
            }            
            return $this;
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = 'Panjang '.$this->name.' minimal '.$length.' karakter';
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = 'Panjang '.$this->name.' maksimal '.$length.' karakter';
                }
