...
$upload_dir ="/userfiles/file/".$_d['dir']."/media/source/"; // path from base_url to base of upload folder (with start and final /)
$current_path ="../../userfiles/file/".$_d['dir']."/media/source/"; // relative path from filemanager folder to upload folder (with final /)
$thumbs_base_path = "../../userfiles/file/".$_d['dir']."/media/thumbs/"; // relative path from filemanager folder to thumbs folder (with final /)
