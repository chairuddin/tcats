...
$r=$mysql->query($sql);
	...
	if($r){
		sweetalert2($type="success",$msg="Hapus Produk berhasil",backendurl("$modul"));
	} else {
		sweetalert2($type="warning",$msg="Produk tidak bisa dihapus karena paket yang terkait dengan produk . Silahkan paket tersebut terlebih dahulu.",backendurl("$modul"));
	}
