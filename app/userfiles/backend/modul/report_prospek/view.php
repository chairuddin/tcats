...
if($action=="ajax_lembaga") {
	$keyword=cleanInput($_GET['search']);
	$q=$mysql->query(" SELECT id,lembaga_nama FROM lembaga WHERE lembaga_nama like '%$keyword%' limit 50 ");
	$data=array();
...
$list_report_prospek=list_report_prospek(array('awal'=>$periode_awal,'akhir'=>$periode_akhir));

echo <<<END
<div class="card">
		<div class="card-header">
		  <h3 class="card-title">Laporan Prospek</h3>  
		  ...
		  <div class="ml-2 mt-4">
			<div class="row">
				<div class="col-md-2">
					<select class="form-control" id="filter"  name="filter" onchange="change_filter();">
						<option value="all">Semua</option>
						<option value="lembaga">By Lembaga</option>
						<option value="produk">By Produk</option>
						<option value="jenis">By Jenis</option>
					</select>
				</div>
				<div class="col-md-2" id="filter2">
