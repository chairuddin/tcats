...
$form_kode=$form->element_Textbox("Kode","kode");
...
if($action=="data") {
	...
	$column_order = array('b.id','b.kode','b.nama');
	$column_search = array('b.kode','b.nama');
	...
	$sql=" SELECT b.id,b.kode,b.nama FROM $modul b  ";
