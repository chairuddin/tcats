     <div class="container">
        <div class="card mb-4 mb-lg-5">
            <div class="card-body">
                ...
                <?php if($pengajuan_ujian_ulang=='deny' and $posttest_exist):?>
                    <div class="d-md-flex alert alert-danger d-flex align-items-center" role="alert">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
                        <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                    </svg>
                        <div>
                            Pengajuan ujian ulang ditolak pada kompetensi ini.
                        </div>
                    </div>
                <?php endif;?>

                <?php if($pengajuan_ujian_ulang=='accept'):?>
                    <div class="d-md-flex alert alert-info d-flex align-items-center" role="alert">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
                        <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                    </svg>
                        <div>
                            Pengajuan ujian ulang diterima pada kompetensi ini. Silakan lakukan ujian ulang!.
                        </div>
                    </div>
                <?php endif;?>
                ...
                <div class="d-md-flex justify-content-between mt-3 footer-detail">
                    ...
                    <?php else:?>
                    <a href="<?php echo fronturl("detail/$md5_posttest_id")?>" class="btn btn-success mt-4 mt-md-0"><i class="fas fa-file-alt"></i> <?=$pengajuan_ujian_ulang=='accept'?'Retake':'Take'?> - Post Test</a>
                    <?php endif;?>
                    <?php if($pengajuan_ujian_ulang!='deny'):?>
                        <?php if($posttest_done and !$is_competent and !$pengajuan_aktif):?>
                        <a href="<?php echo fronturl("retake/$md5_posttest_quiz_done_id")?>" class="btn btn-success mt-4 mt-md-0" ><i class="fas fa-file-alt"></i> Request Retake - Post Test</a>
                        <?php endif?>
                    <?php endif?>
