...
if(!$close_form and $_POST['reset_password']) {
	...
	if($new_password!=$re_new_password) {
		sweetalert2($type="warning",$msg="Password baru harus sama",fronturl('app_reset_password'.$stamp));
	}
			 ...
			 <div class="login-box">
			  <div class="">
				<div class="card-body login-card-body">
				  ...
				  <form action="<?php echo fronturl("app_reset_password/$action")?>" method="post">
