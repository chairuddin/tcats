...
$url_login = fronturl("app_quiz_login");
...
if($token!="")
{
	$q=$mysql->query("SELECT q.*,p.pg paket_pg,p.essay paket_essay,p.complex paket_complex,m.alamat,m.foto,m.asal_instansi FROM app_quiz_done q LEFT JOIN app_quiz_done_paket p ON p.quiz_done_id=q.id LEFT JOIN quiz_member m on m.id=q.member_id WHERE q.token='$token' AND q.is_done=0");
...
<div id="left-panel">
	...
	<div class="thumbnail-panel">
		...
		<div class="data-user">
			...
			<div class="content-user"><?php echo $member_data['member_username']; ?></div> 
		</div>
		<div class="data-user">
		...
		<div class="data-user">
			<label>Email</label>
			<div class="content-user"><?php echo $member_data['email']; ?></div>
		</div>
	</div>
</div>
<div id="right-panel">
...
if($web_config_show_footer_instansi==1 and false){
...
<div id="block-list-jawaban" class="active">
	<div class="">
...
$url_done=fronturl("app_quiz_done");
$fronturl=fronturl("app_ajax");
