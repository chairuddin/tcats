...
if($_POST['submit']!='' AND $_POST['time']=='') {

	header("location:$this_url&time=".time());
	die();
}
...
<?php echo $foto?>
<form id="quiz_form_login" name="quiz_form_login"  method="get" role="form" class="quiz_form_login">
...
<form method="get" role="form" class="quiz_form_login ">
<div class="logo">
...
function initializeClock(id, endtime,init_start) {
  ...
  var timeinterval = setInterval(updateClock, 1000);
	...
	if($("#clockdiv").length>0){
		setTimeout(function(){initializeClock('clockdiv', deadline,init_start);},500);
	}
