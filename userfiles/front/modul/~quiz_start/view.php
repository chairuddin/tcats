				...
				foreach($pilihan as $i=>$pil)
				{
					...
					<li>
						<div class="kolom_input">		
							<input mark-choice="mark-value" onchange="onchange_jawaban('<?php echo $pil.$no;?>');" onclick="<?php echo $no<$total?"tampilkan_soal_delay('".($no+1)."')":""; ?>" class="radio_pilihan icheck-me"  <?php echo $checked;?> id="<?php echo $pil.$no;?>" type="radio" meta-urutan="<?php echo $no;?>" meta-name="soal<?php echo $no;?>" meta-label="label_<?php echo $pil.$no;?>" name="soal_<?php echo $no_sss;?>" value="<?php echo $pil;?>" />
							<label id="label_<?php echo $pil.$no;?>" onclick="<?php echo $no<$total?"tampilkan_soal_delay('".($no+1)."')":""; ?>" class="soal<?php echo $no;?> <?php echo $class_checked;?>" for="<?php echo $pil.$no;?>">
							<div class="abjad"></div>
...
function reload_answer(){
	...
	if(answer_storage!=null && answer_storage!=undefined && answer_storage!='') {
...
var deadline = new Date(Date.parse(new Date()) + ($quiz_left_duration * 1000));
	...
	function load_jawaban()
	{
	 ...
	 if(online==1){
		...
		if(answer_storage!=null && answer_storage!=""){
...
function onchange_jawaban(id_soal) {

		nomor=parseInt($("#"+id_soal).attr("meta-urutan"));
		...
		nama_soal=$("#"+id_soal).attr("meta-name");
		jawab_soal="jawab_"+$("#"+id_soal).attr("meta-name");
		mark_choice=$("#"+id_soal).attr("mark-choice");
		nilai_soal=$("#"+id_soal).val();
		...
		//fungsi dari oclick pindah sini
		metalabel=$("#"+id_soal).attr('meta-label');
		metaname=$("#"+id_soal).attr('meta-name');
		urutan=$("#"+id_soal).attr('meta-urutan');
		name=$("#"+id_soal).attr('meta-name');
