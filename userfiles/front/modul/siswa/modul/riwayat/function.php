...
function list_riwayat() {
	...
	$q=$mysql->query(" SELECT id,token,quiz_title_id,quiz_id,score,score_essay,check_point,is_done,bahas_log FROM quiz_done WHERE (member_code='$member_code' OR member_id='$member_id') ORDER BY check_point DESC  ");
	$data = array();
