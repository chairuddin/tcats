			 ...
			 <div class="login-box">
			  ...
			  <div class="card">
				<div class="card-body login-card-body">
				  ...
				  <form action="<?php echo fronturl("siswa/login")?>" method="post">
					<div class="input-group mb-3">
					  <input tabindex="1" type="text" class="form-control" name="username" placeholder="Username">
					...
					<div class="input-group mb-3">
					  <input tabindex="2" type="password" class="form-control" name="password" placeholder="Password">
					  <div class="input-group-append">
						<div class="input-group-text">
					...
					<div class="row">
					  <div class="col-8">
						<div class="icheck-primary">
						   <a tabindex="4" href="<?php echo fronturl("siswa/lupa_password")?>">Lupa password</a>
						</div>
					  </div>
					  <!-- /.col -->
					  <div class="col-4">
						<button type="submit" tabindex="3" name="do_login" value="1" class="btn btn-primary btn-block">Login</button>
					  </div>
