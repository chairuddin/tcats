    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?php echo fronturl("siswa/edit_profil");?>" class="dropdown-item">
			<i class="fas fa-user  mr-2"></i>  Edit Profil</a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block"><?php echo $biodata_fullname;?></a>
        </div>
      </div>
