...
if($token!="")
{
	$q=$mysql->query("SELECT q.*,p.pg paket_pg,p.essay paket_essay,p.complex paket_complex FROM quiz_done q LEFT JOIN quiz_done_paket p ON p.quiz_done_id=q.id WHERE q.token='$token' AND q.is_done=0");
...
<div id="left-panel">
	...
	<div class="thumbnail-panel">
		<img class="photo-user" src="https://statinfer.com/wp-content/uploads/dummy-user.png">
		<div class="data-user">
		...
		<div class="data-user">
			...
			<div class="content-user">IAIN Surabaya</div>
		</div>
		<div class="data-user">
			<label>Alamat</label>
			<div class="content-user">Jl Lorem Ipsum No. 24</div>
		</div>
	</div>
</div>
<div id="right-panel">
...
?>
	...
	<div class="thumbnail-panel" id="lab-button">
		<a href="#">Lihat Data Laboratorium</a>
	</div>
</div>
