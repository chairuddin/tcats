...
if(!$close_form and $_POST['reset_password']) {
	$new_password=$_POST['new_password'];
	$re_new_password=$_POST['re_new_password'];
	if($new_password!=$re_new_password) {
		sweetalert2($type="warning",$msg="Password baru harus sama",backendurl('app_reset_password'.$stamp));
	}
	...
	if($renew) {
	    $close_form=true;
	    $msg="<div>Password berhasil diperbaharui silahkan login</div>";
	} else {
	    $close_form=true;
	    $msg="Password gagal diperbaharui silahkan lakukan reset password kembali";
	}
}
			 ...
			 <div class="login-box">
			  <div class="">
				<div class="card-body login-card-body">
				  ...
				  <form action="<?php echo backendurl("app_reset_password/$action")?>" method="post">
				  ...
				  <?php endif;?>
                   ...
                   <?php if($close_form): ?>
                   <?php echo $msg;?>
				   <a class="btn btn-success btn-medium" href="<?=backendurl()?>">Login</a>
                   <?php endif;?>
