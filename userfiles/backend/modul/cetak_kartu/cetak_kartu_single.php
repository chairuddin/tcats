...
<body>
	...
	?>
		<table style="width:10.2cm;border:1px solid black; padding-top:6px; font-family:Arial, Helvetica, sans-serif; font-size:12px" class="kartu kartu-wrapper" border="0">
			<tbody>
				...
				<!--</tr>-->
				<tr>
					<td colspan="3" style="height:1.6cm"></td>
				</tr>
				<tr height="10px">
					<td style="width:32%">&nbsp;NIK</td>
					<td style="width:1%">:</td>
					<td style="font-size:12px;font-weight:normal;"><?php echo $nomor_ujian; ?></td>
				</tr>
				<tr height="10px">
					<td width="90">&nbsp;Full Name</td>
					<td width="8">:</td>
					<td width="226" style="font-size:12px;font-weight:normal;"><?php echo $nama_siswa ?></td>
				</tr>
				<tr height="10px">
					<td width="90">&nbsp;Organization Unit</td>
					<td width="8">:</td>
					<td width="226" style="font-size:12px;font-weight:normal;"><?php echo $organization_unit ?></td>
				</tr>
				<tr height="20px">
					<td width="90">&nbsp;Position</td>
					<td width="8">:</td>
					<td width="226" style="font-size:12px;font-weight:normal;"><?php echo $position ?></td>
				</tr>
				...
				<tr>
					<td colspan="3">
						<table border="0" width="100%" style="margin-top:-12px">
							<tr height="10px">
								<td valign="top" align="center" style="font-size:12px;font-weight:bold;width:100%;">
									<!--<?php echo $nama_sekolah; ?><br/>-->
									<!--Ttd ,<br/><br/>-->
									<!--<?php echo $nama_kepsek; ?>-->
								</td>
								<td " align=" right" style="padding-right:14px"><img src="<?php echo $url_qrcode; ?>" height="64px" border="thin solid red"></td>
							</tr>
	...
	extract($var_config);
	$data_peserta = [];
	$q = $mysql->query("SELECT id,username,fullname,jurusan,class, ruang,organization_unit,position FROM quiz_member WHERE id='$id'");
	$urut = 1;
	...
	<table width="100%" border="0" style="margin-top:8px;">
		...
		?>
			<tr>
				...
				<td><?php $kolom++;
					is_array($data_peserta[$kolom]) ? kartu($data_peserta[$kolom]) : ''; ?></td>
			</tr>
		<?php
			$kolom++;
		}
